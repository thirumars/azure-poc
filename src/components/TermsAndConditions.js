    ...
    return (
      <View style={styles.container}>
        ...
        <div style={{float: 'right'}}>
          <TouchableOpacity disabled={!this.state.accepted} onPress={() => alert(this.state.message)} style={this.state.accepted ? styles.acceptButton : styles.acceptButtonDisabled}><Text style={styles.acceptButtonLabel}>Accept</Text></TouchableOpacity>
        </div>
        <div style={{float: 'left'}}>
          <TouchableOpacity disabled={!this.state.accepted} onPress={() => alert(this.state.message)} style={this.state.accepted ? styles.deniedButton : styles.deniedButtonDisabled}><Text style={styles.deniedButtonLabel}>Denied</Text></TouchableOpacity>
        </div>
      </View>
    );
  }
